...
<html>
    ...
    <body>
        <h1 align="center"> Studenti:</h1>
        <br/>
        <h2><p align="center"><a href="nou_Student.jsp"><b>Adauga un nou student.</b></a></p></h2>
        <%
            jb.connect();
            ...
            String[] valori = {Nume, Prenume, String.valueOf(Medie), String.valueOf(NrAbsente)};
            String[] campuri = {"nume", "prenume", "medie", "nrAbsente"};
